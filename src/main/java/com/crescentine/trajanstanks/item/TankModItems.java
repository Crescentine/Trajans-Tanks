...
public class TankModItems {
    ...
    public static final RegistryObject<Item> JAGDPANTHER_ITEM = ITEMS.register("jagdpanther_item", () -> new TankSpawnEgg(TankModEntityTypes.JAGDPANTHER_ENTITY_TYPE, 0xFFFFFF, 0xFFFFFF, false, false, false, false, true, (new Item.Properties()).tab(TankModItemGroup.TANK_MOD_ITEM_GROUP)));
    ...
    public static final RegistryObject<Item> ARCHER_BLUEPRINT = ITEMS.register("archer_blueprint", () -> new Item(new Item.Properties().tab(PartsItemGroup.TANK_MOD_PARTS)));
    ...
    public static final RegistryObject<Item> KV2_BLUEPRINT = ITEMS.register("kv2_blueprint", () -> new Item(new Item.Properties().tab(PartsItemGroup.TANK_MOD_PARTS)));
    public static final RegistryObject<Item> JAG_BLUEPRINT = ITEMS.register("jag_blueprint", () -> new Item(new Item.Properties().tab(PartsItemGroup.TANK_MOD_PARTS)));
   }
