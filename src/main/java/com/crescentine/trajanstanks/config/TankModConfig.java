...
public class TankModConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> panzer2_health;
    ...
    //luchs
    public static final ForgeConfigSpec.ConfigValue<Integer> luchs_health;
    ...
    //somua
    public static final ForgeConfigSpec.ConfigValue<Integer> somua_health;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> t34_health;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> tiger_health;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> cruisermk1_health;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> m4sherman_health;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> archer_health;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> kv2_health;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> jagdpanther_health;
    ...
    static {
        ...
        panzer2_health = BUILDER.define("Panzer 2 Health (0-250)" , 400);
        ...
        luchs_health = BUILDER.define("Luchs Health (0-250)" , 250);
        ...
        somua_health = BUILDER.define("Somua Health (0-250)" , 350);
        ...
        tiger_health = BUILDER.define("Tiger Health (0-250)" , 800);
        ...
        t34_health = BUILDER.define("T-34 Health (0-250)" , 375);
        ...
        cruisermk1_health = BUILDER.define("Cruiser MK1 Health (0-250)" , 300);
        ...
        m4sherman_health = BUILDER.define("M4 Sherman Health (0-250)" , 300);
        ...
        archer_health = BUILDER.define("Archer Health (0-250)" , 200);
        ...
        kv2_health = BUILDER.define("KV-2 Health (0-250)" , 500);
        ...
        jagdpanther_health = BUILDER.define("Jagdpanther Health (0-250)" , 300);
